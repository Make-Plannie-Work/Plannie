                    ...
                    <table class="table table-hover table-borderless text-white">
                        ...
                        <c:forEach items="${groepsLedenLijst}" var="groepslid">
                            <tr>
                                ...
                                <td><c:if test = "${groep.aanmaker == currentUser.gebruikersId}"><a id="Verwijder${groepslid.voornaam}UitGroep" href="${groep.groepId}/VerwijderLedenUitGroep/${groepslid.gebruikersId}">
