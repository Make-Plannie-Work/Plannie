                                ...
                                <c:choose>
                                    ...
                                    <c:when test="${soortReisItem == 'MakePlannieWork.Plannie.model.reisitem.Locatie'}">
                                        ...
                                        <div class="card-block px-2">
                                            ...
                                            <div class="googleMapSmall" id="map${reisItems.reisItemId}"></div>
                                            <div id="coordinaten${reisItems.reisItemId}" data-latitude="${reisItems.latitude}" data-longitude="${reisItems.longitude}"></div>
                                        </div>
                                    </c:when>
                                    <c:otherwise>
                                        <div class="card-header border-0">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <a class="dropdown-item" id="locatieKeuze"
                               href="/${groep.groepId}/reisItemDetail/${reisItem.reisItemId}/LocatieAanmaken">Een Locatie</a>
